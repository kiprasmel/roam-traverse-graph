...
/**
 * @type { import("./types").RemoveUnknownPropertiesRecursively }
 */
const removeUnknownPropertiesRecursively = ({
	block, //
	// parentBlock,
}) =>
	traverseBlockRecursively(block, () =>
		/**
 ...
 */
const markBlockPublicRecursively = ({
	block, //
	// parentBlock,
	rootParentPage,
